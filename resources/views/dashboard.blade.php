...
<main class="p-8">
            <div class="max-w-7xl mx-auto">
                <div class="mb-8">
                    ...
                    <p class="mt-1 text-sm text-gray-500 dark:text-gray-400">Smart Letter Archiving System</p>
                </div>
                <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
                    <div class="stat-card bg-white dark:bg-gray-800 overflow-hidden shadow-sm dark:shadow-gray-900/50 sm:rounded-lg">
                        <div class="p-6">
                            <div class="flex items-center">
                                ...
                                <div class="ml-4 flex-1">
                                    <p class="text-sm font-medium text-gray-500 dark:text-gray-400">Total Arsip</p>
                                    <div class="flex items-center gap-2">
                                        <p class="stat-value text-2xl font-semibold text-gray-900 dark:text-gray-100" data-target="{{ $totalArchives }}">0</p>
                        ...
                        <div class="p-6">
                            <div class="flex items-center">
                                ...
                                <div class="ml-4 flex-1">
                                    ...
                                    <div class="flex items-center gap-2">
                                        <p class="stat-value text-2xl font-semibold text-gray-900 dark:text-gray-100" data-target="{{ $totalCategories }}">0</p>
                    ...
                    <div class="stat-card bg-white dark:bg-gray-800 overflow-hidden shadow-sm dark:shadow-gray-900/50 sm:rounded-lg">
                        <div class="p-6">
                            <div class="flex items-center">
                                ...
                                <div class="ml-4 flex-1">
                                    <p class="text-sm font-medium text-gray-500 dark:text-gray-400">Arsip Bulan Ini</p>
                                    <div class="flex items-center gap-2">
                                        <p class="stat-value text-2xl font-semibold text-gray-900 dark:text-gray-100" data-target="{{ $archivesThisMonth }}">0</p>
                    ...
                    <div class="stat-card bg-white dark:bg-gray-800 overflow-hidden shadow-sm dark:shadow-gray-900/50 sm:rounded-lg">
                        <div class="p-6">
                            <div class="flex items-center">
                                ...
                                <div class="ml-4 flex-1">
                                    <p class="text-sm font-medium text-gray-500 dark:text-gray-400">Arsip Tahun Ini</p>
                                    <div class="flex items-center gap-2">
                                        <p class="stat-value text-2xl font-semibold text-gray-900 dark:text-gray-100" data-target="{{ $archivesThisYear }}">0</p>
                ...
                <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm dark:shadow-gray-900/50 sm:rounded-lg mb-8">
                    <div class="p-6">
                        <h3 class="text-lg font-medium text-gray-900 dark:text-gray-100 mb-4">Aktivitas Surat 7 Hari Terakhir</h3>
                        <div id="weeklyChart"></div>
                    </div>
                </div>
                <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
                    <div class="lg:col-span-2 bg-white dark:bg-gray-800 overflow-hidden shadow-sm dark:shadow-gray-900/50 sm:rounded-lg">
                        <div class="p-6">
                            <h3 class="text-lg font-medium text-gray-900 dark:text-gray-100 mb-4">Arsip Terbaru</h3>
                            @if($recentArchives->count() > 0)
                                <div class="overflow-x-auto">
                                    <table class="min-w-full divide-y divide-gray-200 dark:divide-gray-700">
                                        <thead class="bg-gray-50 dark:bg-gray-800/50">
                                            <tr>
                                                <th class="px-4 py-3 text-left text-xs font-medium text-gray-500 dark:text-gray-400 uppercase tracking-wider">Nomor Dokumen</th>
                                        ...
                                        <tbody class="bg-white dark:bg-gray-800 divide-y divide-gray-200 dark:divide-gray-700">
                                            @foreach($recentArchives as $archive)
                                                <tr class="hover:bg-gray-50 dark:hover:bg-gray-700 dark:bg-gray-800/50">
                                                    <td class="px-4 py-3 whitespace-nowrap text-sm font-medium text-gray-900 dark:text-gray-100">
                                                        {{ $archive->document_number }}
                                                    </td>
                                                    <td class="px-4 py-3 text-sm text-gray-900 dark:text-gray-100 max-w-xs truncate">
                                                        <a href="{{ route('archives.show', $archive) }}" class="text-indigo-600 dark:text-indigo-400 hover:text-indigo-900 dark:hover:text-indigo-300">
                                                            {{ $archive->title }}
                                                        </a>
                                                    </td>
                            ...
                            @else
                                <p class="text-sm text-gray-500 dark:text-gray-400">Belum ada arsip.</p>
                            @endif
                        </div>
                    </div>
                    <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm dark:shadow-gray-900/50 sm:rounded-lg">
                        <div class="p-6">
                            <h3 class="text-lg font-medium text-gray-900 dark:text-gray-100 mb-4">Arsip per Kategori</h3>

    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="flex justify-between h-16">
            <div class="flex">
                ...
                <div class="shrink-0 flex items-center">
                    <a href="{{ route('dashboard') }}">
                        <img src="{{ asset('images/logo/logounsub.png') }}" alt="SIPAS UNSUB" class="block h-14 w-auto">
                    </a>
                </div>
            ...
            <div class="hidden sm:flex sm:items-center sm:ms-6 sm:space-x-3">
                <!-- Dark Mode Toggle -->
                <button id="dark-toggle" class="p-2 rounded-lg text-gray-500 dark:text-gray-400 hover:bg-gray-100 dark:hover:bg-gray-700 focus:outline-none focus:ring-2 focus:ring-indigo-500 transition" onclick="toggleDarkMode()" aria-label="Toggle dark mode">
            ...
            <div class="-me-2 flex items-center sm:hidden">
                <div class="flex items-center space-x-2 me-2">
                    <button id="dark-toggle-mobile" class="p-2 rounded-lg text-gray-500 dark:text-gray-400 hover:bg-gray-100 dark:hover:bg-gray-700 focus:outline-none focus:ring-2 focus:ring-indigo-500 transition" onclick="toggleDarkMode()" aria-label="Toggle dark mode">
                        <svg id="sun-icon-mobile" class="hidden w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 3v1m0 16v1m9-9h-1M4 12H3m15.364 6.364l-.707-.707M6.343 6.343l-.707-.707m12.728 0l-.707.707M6.343 17.657l-.707.707M16 12a4 4 0 11-8 0 4 4 0 018 0z" />
                        </svg>
